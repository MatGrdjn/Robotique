...
def _memetic_worker(args):
    ...
    current_score = utils_solver.calculate_fitness_collision(current_path, cylinders, params)
    ...
    for _ in range(search_depth):
        ...
        new_score = utils_solver.calculate_fitness_collision(neighbor, cylinders, params)
